...
namespace FMExtendedListView
{
    public class FMExtendedListView : ListView
    {
        public bool IsPullToRefreshEnabled
        {
            get { return (bool)GetValue(FMExtendedListView.IsPullToRefreshEnabledProperty); }
            set { SetValue(FMExtendedListView.IsPullToRefreshEnabledProperty, value); }
        }
        ...
        public static readonly DependencyProperty IsPullToRefreshEnabledProperty =
            DependencyProperty.RegisterAttached("IsPullToRefreshEnabled", typeof(bool), typeof(FMExtendedListView), new PropertyMetadata(false, OnPullToRefreshEnabledChanged));

        private static void OnPullToRefreshEnabledChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var list = d as FMExtendedListView;
        ...
        {
            get { return (bool)GetValue(FMExtendedListView.IsMoreDataRequestedEnabledProperty); }
            set { SetValue(FMExtendedListView.IsMoreDataRequestedEnabledProperty, value); }
        }
        ...
        public static readonly DependencyProperty IsMoreDataRequestedEnabledProperty =
            DependencyProperty.RegisterAttached("IsMoreDataRequestedEnabled", typeof(bool), typeof(FMExtendedListView), new PropertyMetadata(false));

        public double ScrollProgressToRequestMoreData
        {
            get { return (double)GetValue(FMExtendedListView.ScrollProgressToRequestMoreDataProperty); }
            set { SetValue(FMExtendedListView.ScrollProgressToRequestMoreDataProperty, value); }
        }

        public static readonly DependencyProperty ScrollProgressToRequestMoreDataProperty =
    DependencyProperty.RegisterAttached("ScrollProgressToRequestMoreData", typeof(double), typeof(FMExtendedListView), new PropertyMetadata(false));


        public DataTemplate LoadingPartTemplate
        {
            get { return (DataTemplate)GetValue(FMExtendedListView.LoadingPartTemplateProperty); }
            set { SetValue(FMExtendedListView.LoadingPartTemplateProperty, value); }
        }
        ...
        public static readonly DependencyProperty LoadingPartTemplateProperty =
            DependencyProperty.RegisterAttached("LoadingPartTemplate", typeof(DataTemplate), typeof(FMExtendedListView), new PropertyMetadata(null));
        ...
        {
            get { return (DataTemplate)GetValue(FMExtendedListView.PullToRefreshPartTemplateProperty); }
            set { SetValue(FMExtendedListView.PullToRefreshPartTemplateProperty, value); }
        }
        ...
        public static readonly DependencyProperty PullToRefreshPartTemplateProperty =
            DependencyProperty.RegisterAttached("PullToRefreshPartTemplate", typeof(DataTemplate), typeof(FMExtendedListView), new PropertyMetadata(null));



        public DataTemplate MoreDataProgressTemplate
        {
            get { return (DataTemplate)GetValue(FMExtendedListView.MoreDataProgressTemplateProperty); }
            set { SetValue(FMExtendedListView.MoreDataProgressTemplateProperty, value); }
        }
        ...
        public static readonly DependencyProperty MoreDataProgressTemplateProperty =
            DependencyProperty.RegisterAttached("MoreDataProgressTemplate", typeof(DataTemplate), typeof(FMExtendedListView), new PropertyMetadata(null));
        ...
        public FMExtendedListView()
        {
            this.DefaultStyleKey = typeof(FMExtendedListView);
        }
